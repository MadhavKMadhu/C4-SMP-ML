...
poly = PolynomialFeatures(6)        # create more features from data as terms of X1 and X2 upto the sixth power, called feature mapping, helps us fit the data better
...
# Decision boundaries
# Lambda = 0 : No regularization --> too flexible, overfitting the training data or called high variance
# Lambda = 1 : Looks about right
# Lambda = 100 : Too much regularization --> high bias or called underfitting
